...
public class UserDto {
    ...
    public UserDto(String name, String username, String passWorld, String passWorldCheck, int sso, int phoneNumber, String address, String job, double height, int weight, double bmi, String bodyMath, int randomWeight, double randomHeight) {
        this.name = name;
        this.username = username;
        this.passWorld = passWorld;
        this.passWorldCheck = passWorldCheck;
